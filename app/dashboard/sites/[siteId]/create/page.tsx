  ...
  return (
    <>
      <div className="flex items-center">
        ...
        <h1 className="texl-2xl font-semibold">Create Article</h1>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Please describe your article .Your Article details
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
          ...
          >
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder="Please enter the title of you blog/article."
            ...
            <div className="grid gap-2">
              ...
              <Input
                ...
                placeholder="What is your Article's Slug"
            ...
            <div className="grid gap-2">
              <Label className="text-lg">Article Content</Label>
              <input
                type="hidden"
